...
class ActionDemandInput(BaseModel):
    ...
    version: Optional[str] = Field(
        default=None, description="The exact version of the action."
    )
    name: Optional[str] = Field(
        default=None, description="The display name of the action to match."
    )
    ...
    protocols: Optional[Tuple[str, ...]] = Field(
        default=None,
        description="Protocols (by name) the action must implement, e.g. 'predicate'.",
    )
...
class ActionDependencyInput(BaseModel):
    ...
    demand: Optional[ActionDemandInput] = Field(
        default=None,
...
class ActionFilter(BaseModel):
    ...
    object_demands: Optional[Tuple["PortDemandInput", ...]] = Field(
...
class AgentDependencyInput(BaseModel):
    ...
    action_dependencies: Optional[Tuple[ActionDependencyInput, ...]] = Field(
        alias="actionDependencies",
        default=None,
        description="The named action requirements of the agent — each a slot key plus the demand the resolved action must satisfy.",
    )
    state_dependencies: Optional[Tuple["StateDependencyInput", ...]] = Field(
        alias="stateDependencies",
        default=None,
...
class AgentFilter(BaseModel):
    ...
    state_demands: Optional[Tuple["StateDemandInput", ...]] = Field(
...
class ArgPortInput(PortTrait, BaseModel):
    ...
    proposed_units: Optional[Tuple[str, ...]] = Field(
        alias="proposedUnits",
        default=None,
...
class StateDemandInput(BaseModel):
    ...
    matches: Optional[Tuple[PortMatchInput, ...]] = Field(
        default=None,
        description="The matches the state definition's ports must satisfy.",
    )
    protocols: Optional[Tuple[str, ...]] = Field(
...
class StateDependencyInput(BaseModel):
    ...
    demand: Optional[StateDemandInput] = Field(
        default=None,
...
class ArgChildPortNestedChildren(BaseModel):
    ...
    proposed_units: Optional[Tuple[str, ...]] = Field(
        default=None, alias="proposedUnits"
    )
...
async def afind(
    ...
    matching: Union[Optional[ActionDemandInput], UnsetType] = UNSET,
    rath: Optional[RekuestNextRath] = None,
) -> Action:
    """find
