...
from rekuest_next.funcs import aexecute, subscribe, asubscribe, execute
...
class ActionArgumentInput(BaseModel):
    ...
    value_literal: Optional[JSONSerializable] = Field(
        alias="valueLiteral", default=None
    )
    ...
    value_list: Optional[Tuple["ActionArgumentInput", ...]] = Field(
        alias="valueList", default=None
    )
    value_dict: Optional[Tuple["ActionArgumentInput", ...]] = Field(
        alias="valueDict", default=None
    )
...
class ComponentPropInput(BaseModel):
    ...
    dynamic_value: Optional["DynamicValueInput"] = Field(
        alias="dynamicValue", default=None
    )
...
class ImplementationInput(ImplementationInputTrait, BaseModel):
    ...
    provenance_audience: Optional[Tuple[str, ...]] = Field(
        alias="provenanceAudience", default=None
    )
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class MaterializeBlokInput(BaseModel):
    ...
    agent_mappings: Optional[Tuple[BlokAgentMappingInput, ...]] = Field(
        alias="agentMappings", default=None
    )
...
class ResolvedDependencyInput(BaseModel):
    ...
    auto_resolve: bool = Field(alias="autoResolve")
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
async def aensure_agent(
    name: Optional[str] = None, rath: Optional[RekuestNextRath] = None
) -> Agent:
    """EnsureAgent
    ...
    """
    return (
        await aexecute(EnsureAgentMutation, {"input": {"name": name}}, rath=rath)
    ).ensure_agent
...
def ensure_agent(
    ...
    """
    return execute(
        EnsureAgentMutation, {"input": {"name": name}}, rath=rath
    ).ensure_agent
...
async def aimplement_agent(
    ...
    bloks: Optional[Iterable[BlokImplementationInput]] = None,
    hash: Optional[str] = None,
...
async def aassign(
    ...
    dependencies: Optional[Iterable[ResolvedDependencyInput]] = None,
...
async def acreate_blok(
    name: str,
    dependencies: Optional[Iterable[AgentDependencyInput]] = None,
    description: Optional[str] = None,
    catalog: Optional[str] = None,
    components: Optional[Iterable[ComponentNodeInput]] = None,
    demo_state: Optional[Args] = None,
    rath: Optional[RekuestNextRath] = None,
) -> Blok:
    """CreateBlok
...
async def amaterialize_blok(
    blok: IDCoercible,
    dashboard: Optional[IDCoercible] = None,
    agent_mappings: Optional[Iterable[BlokAgentMappingInput]] = None,
    rath: Optional[RekuestNextRath] = None,
) -> MaterializedBlok:
    """MaterializeBlok
...
async def acreate_dashboard(
    ...
    return (
        await aexecute(
            ...
            {"input": {"name": name, "bloks": bloks, "organization": organization}},
            rath=rath,
        )
    ).create_dashboard
...
async def areserve(
    reference: Optional[str] = "d0a1d14a-668d-4061-bdfd-df84a5ff59aa",
    action: Optional[IDCoercible] = None,
    implementation: Optional[IDCoercible] = None,
    title: Optional[str] = None,
    hash: Optional[ActionHash] = None,
...
async def aunshelve(id: str, rath: Optional[RekuestNextRath] = None) -> ID:
    ...
    """
    return (
        await aexecute(UnshelveMutation, {"input": {"id": id}}, rath=rath)
...
def unshelve(id: str, rath: Optional[RekuestNextRath] = None) -> ID:
    ...
    """
    return execute(
        UnshelveMutation, {"input": {"id": id}}, rath=rath
    ).unshelve_memory_drawer
...
async def alog_patches(
    ...
    """
    return (
        await aexecute(LogPatchesMutation, {"input": {"patches": patches}}, rath=rath)
    ).log_patches
...
def log_patches(
    ...
    """
    return execute(
        LogPatchesMutation, {"input": {"patches": patches}}, rath=rath
    ).log_patches
...
async def alog_snapshot(value: Any, rath: Optional[RekuestNextRath] = None) -> ID:
    ...
    """
    return (
        await aexecute(LogSnapshotMutation, {"input": {"value": value}}, rath=rath)
    ).log_snapshot
...
def log_snapshot(value: Any, rath: Optional[RekuestNextRath] = None) -> ID:
    ...
    """
    return execute(
        LogSnapshotMutation, {"input": {"value": value}}, rath=rath
    ).log_snapshot
...
async def acreate_threed_d_model(
    ...
    return (
        await aexecute(
            ...
            {"input": {"name": name, "description": description, "media": media}},
            rath=rath,
        )
    ).create_threed_model
...
async def aget_agent_by_identifiers(
    ...
    return (
        await aexecute(
            ...
            {"app": app, "version": version, "deviceId": device_id},
            rath=rath,
        )
    ).agent
...
async def arequests(rath: Optional[RekuestNextRath] = None) -> Tuple[Assignation, ...]:
    ...
    Returns:
        List[Assignation]
    """
    return (await aexecute(RequestsQuery, {}, rath=rath)).assignations
...
def requests(rath: Optional[RekuestNextRath] = None) -> Tuple[Assignation, ...]:
    ...
    Returns:
        List[Assignation]
    """
    return execute(RequestsQuery, {}, rath=rath).assignations
...
async def aprimary_actions(
    pagination: Optional[OffsetPaginationInput] = None,
    identifier: Optional[str] = None,
    ordering: Optional[List[ActionOrder]] = None,
    search: Optional[str] = None,
    rath: Optional[RekuestNextRath] = None,
) -> Tuple[PrimaryAction, ...]:
    """PrimaryActions
...
async def areservations(
    ...
    Returns:
        List[Reservation]
    """
    return (await aexecute(ReservationsQuery, {}, rath=rath)).reservations


def reservations(rath: Optional[RekuestNextRath] = None) -> Tuple[Reservation, ...]:
    """reservations
    ...
    Returns:
        List[Reservation]
    """
    return execute(ReservationsQuery, {}, rath=rath).reservations


async def alist_shortcuts(
    pagination: Optional[OffsetPaginationInput] = None,
    filters: Optional[ShortcutFilter] = None,
    ordering: Optional[List[ShortcutOrder]] = None,
    rath: Optional[RekuestNextRath] = None,
) -> Tuple[ListShortcut, ...]:
    """ListShortcuts
    ...
    return (
        await aexecute(
            ListShortcutsQuery,
            {"pagination": pagination, "filters": filters, "ordering": ordering},
            rath=rath,
        )
    ).shortcuts
...
async def asearch_shortcuts(
    ...
    return (
        await aexecute(
            ...
            {"search": search, "values": values, "limit": limit, "offset": offset},
            rath=rath,
        )
    ).options
...
async def asearch_implementations(
    ...
    return (
        await aexecute(
            SearchImplementationsQuery, {"search": search, "values": values}, rath=rath
        )
    ).options
...
async def aimplementations_for(
    ...
    """
    return (
        await aexecute(ImplementationsForQuery, {"hash": hash}, rath=rath)
    ).implementations
...
def implementations_for(
    ...
    Returns:
        List[Implementation]
    """
    return execute(ImplementationsForQuery, {"hash": hash}, rath=rath).implementations
...
async def amy_implementation_at(
    ...
    return (
        await aexecute(
            ...
            {"interface": interface, "actionId": action_id},
            rath=rath,
        )
...
async def aget_test_case(id: ID, rath: Optional[RekuestNextRath] = None) -> TestCase:
    ...
    Returns:
        TestCase
    """
    return (await aexecute(GetTestCaseQuery, {"id": id}, rath=rath)).test_case
...
def get_test_case(id: ID, rath: Optional[RekuestNextRath] = None) -> TestCase:
    ...
    Returns:
        TestCase
    """
    return execute(GetTestCaseQuery, {"id": id}, rath=rath).test_case
...
async def aget_test_result(
    ...
    Returns:
        TestResult
    """
    return (await aexecute(GetTestResultQuery, {"id": id}, rath=rath)).test_result
...
def get_test_result(id: ID, rath: Optional[RekuestNextRath] = None) -> TestResult:
    ...
    Returns:
        TestResult
    """
    return execute(GetTestResultQuery, {"id": id}, rath=rath).test_result
...
async def asearch_test_cases(
    ...
    return (
        await aexecute(
            SearchTestCasesQuery, {"search": search, "values": values}, rath=rath
        )
    ).options
...
async def asearch_test_results(
    ...
    return (
        await aexecute(
            SearchTestResultsQuery, {"search": search, "values": values}, rath=rath
        )
    ).options
...
async def alist_toolboxes(
    ...
    ordering: Optional[List[ToolboxOrder]] = None,
    rath: Optional[RekuestNextRath] = None,
) -> Tuple[ListToolbox, ...]:
    """ListToolboxes
...
async def awatch_assignations(
    ...
    Returns:
        AssignationChangeEvent
    """
    async for event in asubscribe(WatchAssignationsSubscription, {}, rath=rath):
...
def watch_assignations(
    ...
    Returns:
        AssignationChangeEvent
    """
    for event in subscribe(WatchAssignationsSubscription, {}, rath=rath):
        yield event.assignations
...
async def awatch_reservations(
    ...
    Returns:
        Reservation
    """
    async for event in asubscribe(WatchReservationsSubscription, {}, rath=rath):
        yield event.reservations


def watch_reservations(rath: Optional[RekuestNextRath] = None) -> Iterator[Reservation]:
    """WatchReservations
    ...
    Returns:
        Reservation
    """
    for event in subscribe(WatchReservationsSubscription, {}, rath=rath):
        yield event.reservations
