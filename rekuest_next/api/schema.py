...
class MappedActionInput(BaseModel):
...
class MappedAgentInput(BaseModel):
    ...
    key: str
    agent: ID
    mapped_actions: Tuple[MappedActionInput, ...] = Field(alias="mappedActions")
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
async def acreate_blok(
    ...
    Args:
        ...
        uri: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
...
async def areserve(
    instance_id: InstanceID,
    reference: Optional[str] = "e0e9c9a8-9ed6-4e6d-bbd2-deca97f7cc7f",
    action: Optional[IDCoercible] = None,
    implementation: Optional[IDCoercible] = None,
    title: Optional[str] = None,
    hash: Optional[ActionHash] = None,
...
MappedActionInput.model_rebuild()
