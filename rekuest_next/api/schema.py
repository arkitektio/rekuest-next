...
class AgentFilter(BaseModel):
    ...
    distinct: Optional[bool] = Field(alias="DISTINCT", default=None)
    scope: Optional["ScopeFilter"] = Field(default=None, description="Filter by scope")
...
class AssignInput(BaseModel):
    ...
    dependency: Optional[str] = Field(
        default=None,
        description="The dependency key.method to assign when running inside a resolved assignation",
    )
    ...
    method: Optional[str] = Field(
        default=None,
        description="The method key to assign when running inside a resolved assignation",
    )
    ...
    cached: bool = Field(description="Whether the assignation should be cached")
    log: bool = Field(description="Whether the assignation should be logged")
    capture: bool = Field(description="Whether to capture the assignation.")
    ephemeral: bool = Field(description="Whether the assignation is ephemeral")
    ...
    is_hook: Optional[bool] = Field(
        alias="isHook", default=None, description="Whether the assignation is a hook"
    )
...
class CancelInput(BaseModel):
    ...
    assignation: ID = Field(description="The assignation ID to cancel")
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class InterruptInput(BaseModel):
    ...
    assignation: ID = Field(description="The assignation ID to interrupt")
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class PauseInput(BaseModel):
    ...
    assignation: ID = Field(description="The assignation ID to pause")
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class ResumeInput(BaseModel):
    ...
    assignation: ID = Field(description="The assignation ID to resume")
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class StepInput(BaseModel):
    ...
    assignation: ID = Field(description="The assignation ID to step")
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
async def aassign(
    ...
    Args:
        ...
        dependency: The dependency key.method to assign when running inside a resolved assignation
        ...
        method: The method key to assign when running inside a resolved assignation
        interface: The interface of the implementation. Only ussable if you also set agent
        hooks: The hooks of the assignation. This is used to identify the assignation in the system.
        args: The args of the assignation. Its a dictionary of ports and values
        reference: The reference of the assignation. This is used to identify the assignation in the system.
        parent: The parent ID of the assignation. This is used to identify the assignation in the system.
        cached: Whether the assignation should be cached
        log: Whether the assignation should be logged
        capture: Whether to capture the assignation.
        ephemeral: Whether the assignation is ephemeral
        dependencies: The dependencies of the assignation. This maps dependency keys to implementation IDs.
        is_hook: Whether the assignation is a hook
        step: Whether the assignation should step. Ie. go to the next breakpoint
...
async def acancel(
    ...
    Args:
        assignation: The assignation ID to cancel
        rath (rekuest_next.rath.RekuestNextRath, optional): The arkitekt rath client
...
async def ainterrupt(
    ...
    Args:
        assignation: The assignation ID to interrupt
        rath (rekuest_next.rath.RekuestNextRath, optional): The arkitekt rath client
...
async def apause(
    ...
    Args:
        assignation: The assignation ID to pause
        rath (rekuest_next.rath.RekuestNextRath, optional): The arkitekt rath client
...
async def astep(
    ...
    Args:
        assignation: The assignation ID to step
        rath (rekuest_next.rath.RekuestNextRath, optional): The arkitekt rath client
...
async def aresume(
    ...
    Args:
        assignation: The assignation ID to resume
        rath (rekuest_next.rath.RekuestNextRath, optional): The arkitekt rath client
