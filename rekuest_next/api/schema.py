...
class CreateAgentSceneMutationCreateagentsceneModel(BaseModel):
    """A 3D model file."""
...
class CreateAgentSceneMutationCreateagentscene(BaseModel):
    """A scene linking an agent to a 3D model."""

    typename: Literal["AgentScene"] = Field(
        alias="__typename", default="AgentScene", exclude=True
    )
    model: CreateAgentSceneMutationCreateagentsceneModel
    model_config = ConfigDict(frozen=True)


class CreateAgentSceneMutation(BaseModel):
    """No documentation found for this operation."""

    create_agent_scene: CreateAgentSceneMutationCreateagentscene = Field(
        alias="createAgentScene"
    )
    "Create a new agent scene with a 3D model."

    class Arguments(BaseModel):
        """Arguments for CreateAgentScene"""

        input: CreateAgentSceneInput
        model_config = ConfigDict(populate_by_name=True)

    class Meta:
        """Meta class for CreateAgentScene"""

        document = "fragment MediaStore on MediaStore {\n  path\n  key\n  bucket\n  __typename\n}\n\nmutation CreateAgentScene($input: CreateAgentSceneInput!) {\n  createAgentScene(input: $input) {\n    model {\n      id\n      name\n      file {\n        ...MediaStore\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}"
...
async def areserve(
    instance_id: InstanceID,
    reference: Optional[str] = "ee70cd06-4b52-495d-95b4-e6123855e673",
    action: Optional[IDCoercible] = None,
    implementation: Optional[IDCoercible] = None,
    title: Optional[str] = None,
    hash: Optional[ActionHash] = None,
...
async def acreate_agent_scene(
    model_id: IDCoercible,
    agent_id: IDCoercible,
    transfer_function: str,
    rath: Optional[RekuestNextRath] = None,
) -> CreateAgentSceneMutationCreateagentscene:
    """CreateAgentScene

    Create a new agent scene with a 3D model.

    Args:
        model_id: The `ID` scalar type represents a unique identifier, often used to refetch an object or as key for a cache. The ID type appears in a JSON response as a String; however, it is not intended to be human-readable. When expected as an input type, any string (such as `"4"`) or integer (such as `4`) input value will be accepted as an ID. (required)
        agent_id: The `ID` scalar type represents a unique identifier, often used to refetch an object or as key for a cache. The ID type appears in a JSON response as a String; however, it is not intended to be human-readable. When expected as an input type, any string (such as `"4"`) or integer (such as `4`) input value will be accepted as an ID. (required)
        transfer_function: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        rath (rekuest_next.rath.RekuestNextRath, optional): The arkitekt rath client
...
async def aset_extension_implementations(
    ...
    Args:
        locks: The locks to set on the implementations. This is used to identify the locks in the system.
